...
params: 
  genelist: "/mnt/nfs1/SpliceViz/diseaseEnrichment/input/AD.OTgeneList.txt"
output: 
...
dgn_emapplot <- clusterProfiler::emapplot(entrez_dgn, showCategory = 30, color = "p.adjust") +
  theme_void(base_size = 8, base_family = "Helvetica") +
  scale_color_envisagenics(discrete = FALSE) +
...
##de
de_cnetplot <- clusterProfiler::cnetplot(entrez_de, layout = "kk") +
  theme_void(base_size = 8, base_family = "Helvetica") +
  scale_color_envisagenics(discrete = TRUE) +
  theme(legend.position = "none")
...
de_emapplot <- clusterProfiler::emapplot(entrez_de, showCategory = 30, color = "p.adjust") +
  theme_void(base_size = 8, base_family = "Helvetica") +
  scale_color_envisagenics(discrete = FALSE) +
  theme(legend.position = "right")
